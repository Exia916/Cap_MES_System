...
type PostBody = {
  ...
  emblemType?: string | null; // maps to emblem_type
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const params = [
      ...
      toNullableStr(body.emblemType),
      toNullableStr(body.logoName),
      toNullableInt(body.pieces),
    ...
    console.error("emblem-production-entry POST error:", err);
